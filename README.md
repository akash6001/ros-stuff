...
| ------------- | ------------- | ------------- |
| 1.  | [Setting up ROS 2 using Pixi](https://github.com/akash6001/ros-stuff/blob/main/1-pixi-setup.md)  | Pixi is a package manager for Python environments which supports ROS 2. |
| 2.  | [Using tmux together with Pixi](https://github.com/akash6001/ros-stuff/blob/main/2-tmux-setup.md)  | `tmux` makes it easy to manage multiple terminal panes, which is essential for ROS 2 development. |
| 3.  | [Automating using zshrc](https://github.com/akash6001/ros-stuff/blob/main/3-shortcuts.md)  | Sample script to speed up development process |
